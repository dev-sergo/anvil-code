...
- TS2339 "Property 'X' does not exist" on a Fastify Request/Reply → don't add custom properties to request/reply. For request duration use reply.elapsedTime (number, ms) in an onResponse hook — not a custom request.start field.
