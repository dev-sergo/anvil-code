...
**Статус:** 🟢 v1.61 done (2026-05-18). Qwen3-35B MoE 32K — **11 tok/s**, sandbox **3/3 ✅**, vite **3/4** (V1+V5+V6 ✅, V3 test fail). V1 (config.ts 2728 строк) теперь коммитит — был model-ceiling для всех dense моделей. 588 тестов.
