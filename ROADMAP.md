...
**Статус:** 🟢 v1.55 done (2026-05-16). Structural anchor v3 (current content в property arrow error). L6: 3/4 (без регрессии). Sandbox smoke 3/3 ✅. Cross-repo vite: 2/6. Remaining ceiling: context.ts 780 строк нужен 32K aux. 589 тестов.
