...
## Снимок состояния (2026-06-15)

**Статус:** 🧊 законсервирован на v1.71. Проект завершён как инструмент. Возобновить при: появлении новой модели под 3090, конкретной боли от реального использования, или новой фиче с чётким ROI.
